...
WebGLRenderer.prototype = {
  render: function(container) {
    ...
    var attrs = [{
      loc: shader.attributes.position.location,
      size: 2
    }, {
      loc: shader.attributes.pivot.location,
      size: 2
    }, {
      loc: shader.attributes.atlasPos.location,
      size: 2
    }, {
      loc: shader.attributes.transform.location[0],
      size: 2
    }, {
      loc: shader.attributes.transform.location[1],
      size: 2
    }, {
      loc: shader.attributes.offset.location,
      size: 2
    }];
    ...
    attrs.reduce(function(b, o) {
      ...
      gl.vertexAttribPointer(o.loc, o.size, gl.FLOAT, false,
        SpriteBytes, b);
      return b + 4 * o.size;
    }, 0);
